...
from chaingreen.wallet.derive_keys import master_sk_to_singleton_owner_sk
from chaingreen.wallet.rl_wallet.rl_wallet import RLWallet
from chaingreen.wallet.derive_keys import master_sk_to_farmer_sk, master_sk_to_pool_sk, master_sk_to_wallet_sk
...
from chaingreen.wallet.util.trade_utils import trade_record_to_dict
...
class WalletRpcApi:
    def __init__(self, wallet_node: WalletNode):
        ...
        self.service_name = "chaingreen_wallet"
    ...
    async def _state_changed(self, *args) -> List[WsRpcMessage]:
        ...
        return [create_payload_dict("state_changed", data, "chaingreen_wallet", "wallet_ui")]
    ...
    async def create_new_wallet(self, request: Dict):
        ...
        if request["wallet_type"] == "cc_wallet":
            ...
            if request["mode"] == "new":
                ...
                from chaingreen.pools.pool_wallet_info import initial_pool_state_from_dict
