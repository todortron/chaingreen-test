...
class FullNode:
    ...
    async def short_sync_backtrack(
        self, peer: ws.WSChaingreenConnection, peak_height: uint32, target_height: uint32, target_unf_hash: bytes32
    ):
        """
    ...
    async def new_peak(self, request: full_node_protocol.NewPeak, peer: ws.WSChaingreenConnection):
        """
    ...
    async def send_peak_to_timelords(
        self, peak_block: Optional[FullBlock] = None, peer: Optional[ws.WSChaingreenConnection] = None
    ):
        """
    ...
    async def on_connect(self, connection: ws.WSChaingreenConnection):
        """
    ...
    async def peak_post_processing(
        self, block: FullBlock, record: BlockRecord, fork_height: uint32, peer: Optional[ws.WSChaingreenConnection]
    ):
        """
    ...
    async def respond_block(
        ...
        peer: Optional[ws.WSChaingreenConnection] = None,
    ) -> Optional[Message]:
        """
    ...
    async def new_infusion_point_vdf(
        self, request: timelord_protocol.NewInfusionPointVDF, timelord_peer: Optional[ws.WSChaingreenConnection] = None
    ) -> Optional[Message]:
